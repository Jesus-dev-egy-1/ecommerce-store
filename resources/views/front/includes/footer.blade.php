                        ...
                        <div class="nov-html col-xl-4 col-lg-4 col-md-4">
                            <div class="block">
                                <div class="block_content">
                                    <p class="logo-footer"><img src="" alt="SOUQ MASR" /></p>
                                    <div class="data-contact d-flex align-self-stretch">
                                        ...
                                        <div class="content-data-contact">
                                            ...
                                            <div class="phone-support">201116001260+</div>
                                        </div>
                                    </div>
                                    <div class="data-contact d-flex align-self-stretch">
                                        ...
                                        <div class="content-data-contact">
                                            ...
                                            <div class="content-info-contact">october 40 building project <br /> Max-Tech INC.</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 align-items-center justify-content-md-start justify-content-sm-center d-flex pb-xs-max-20 flex-center">
                    <span>
            Copyright © 2020 Max-Tech Smart-Technologies . All Rights Reserved
          </span>
               </div>
